...
if __name__ == '__main__':
    ...
    for rep in range(repeat):
        ...
        results_svgd[rep, :, :] = SVGD().svgd_updates(x0=theta0, lnprob=model.dlnprob, inner_iteration=inner_iteration, outer_iteration=outer_iteration,
                                  stepsize=1e-1, X_test=X_test, y_test=y_test, evaluation=model.evaluation)
